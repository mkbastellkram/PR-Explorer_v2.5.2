/* ============================================================
   PR Explorer · V3.0.7 Additive Patch
...
function exportZip(){
  ...
  const blob=zipStore(files); downloadBlob('PRX-roadmap-export-v3.0.7.zip', blob);
}
...
/* ============================================================
   PR Explorer · V3.0.7 Runtime Hotfixes
   ============================================================ */
(function(){
  'use strict';
  const KEY_STATE='prx301_state';
...
/* ============================================================
   PR Explorer · V3.0.7 Final Runtime Corrections
   ============================================================ */
(function(){
  'use strict';
...
/* PR Explorer · V3.0.7 Conservative Safe-Area Background Only */
(function(){
  'use strict';
  function boot(){
...
/* PR Explorer · V3.0.7 Remove experimental overlays */
(function(){
  function removeOverlays(){
    document.documentElement.classList.add('prx307-nooverlay');
    document.querySelectorAll('#prx305DockBg,#prx306SafeBg,#prx304SafeBg').forEach(el=>el.remove());
  }
  if(document.readyState==='loading') document.addEventListener('DOMContentLoaded',removeOverlays); else removeOverlays();
  new MutationObserver(removeOverlays).observe(document.documentElement,{childList:true,subtree:true});
  setInterval(removeOverlays,1200);
})();
